...
/**
 * Unit tests for {@link AnterosCupsPrinter} class.
 *
 * @author oboehm
 */
public final class CupsPrinterTest {
    ...
    private static AnterosCupsPrinter printer;

    @BeforeClass
    public static void setUpPrinter() {
    	System.setProperty("printer","TESTE");
        printer = getPrinter();
...
//    }
    ...
    private PrintRequestResult print(AnterosCupsPrinter printer, File file) {
    ...
    private PrintJob createPrintJob(File file) {
        return createPrintJob(file, AnterosCupsClient.DEFAULT_USER);
    }
     ...
     * @return the printer
     */
    public static AnterosCupsPrinter getPrinter()  {
     ...
     * @return printer
     */
    public static AnterosCupsPrinter getPrinter(String name) {
        try {
            List<AnterosCupsPrinter> printers = TestCups.getCupsClient().getPrinters();
