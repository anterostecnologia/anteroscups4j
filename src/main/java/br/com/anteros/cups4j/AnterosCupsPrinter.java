...
import br.com.anteros.cups4j.ipp.ResponseException;
...
public class AnterosCupsPrinter {
   ...
   */
  public AnterosCupsPrinter(URL printerURL, String printerName, boolean isDefault) {
  ...
  public int createJob(String jobName) {
    return createJob(jobName, AnterosCupsClient.DEFAULT_USER);
  }
  ...
  public JobStateEnum getJobStatus(int jobID) throws Exception {
    return getJobStatus(AnterosCupsClient.DEFAULT_USER, jobID);
  }
