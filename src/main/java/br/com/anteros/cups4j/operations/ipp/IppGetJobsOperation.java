...
import br.com.anteros.cups4j.JobStateEnum;
...
public class IppGetJobsOperation extends IppOperation {
  ...
  public List<PrintJobAttributes> getPrintJobs(AnterosCupsPrinter printer, WhichJobsEnum whichJobs, String userName,
