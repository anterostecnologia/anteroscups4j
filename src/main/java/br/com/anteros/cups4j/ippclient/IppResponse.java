...
import br.com.anteros.cups4j.ipp.attributes.SetOfEnum;
        ...
        if ((attributeName != null) && (attributeName.equals(nameOfAttribute))) {
          ...
          for (int z = 0; z < lll; z++) {
            ...
            if (attributeValue.getSetOfEnum() != null) {
              ...
              List<br.com.anteros.cups4j.ipp.attributes.Enum> enumList = setOfEnum.getEnum();
              int llll = enumList.size();
              for (int w = 0; w < llll; w++) {
                br.com.anteros.cups4j.ipp.attributes.Enum enumEntry = enumList.get(w);
