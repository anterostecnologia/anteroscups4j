...
import br.com.anteros.cups4j.util.ByteArrayBuilder;
import br.com.anteros.cups4j.util.ByteUtilities;
import br.com.anteros.cups4j.util.FileUtilities;
...
public class PrintRaw {
     ...
     */
    public boolean print() throws IOException, InterruptedException, Exception {
        return print(null);
    }
     ...
     * @throws InterruptedException
     */
    public boolean print(byte[] data) throws IOException, Exception, InterruptedException {
     ...
     * @throws Exception 
     */
    public static boolean print(PrintService printService, String rawCmds) throws Exception {
