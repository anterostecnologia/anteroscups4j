...
public class PrintJobAttributes {
  ...
  public URL getJobURL(AnterosCupsClient client) throws Exception {
    return client.getJobAttributes(getJobID()).getJobURL();
  }

  public int getPagesPrinted(AnterosCupsClient client) throws Exception {
    return client.getJobAttributes(getJobID()).getPagesPrinted();
  }

  public int getSize(AnterosCupsClient client) throws Exception {
    return client.getJobAttributes(getJobID()).getSize();
  }

  public String getCreateDate(AnterosCupsClient client) throws Exception {
    return this.dateFormat.format(client.getJobAttributes(getJobID()).getJobCreateTime());
  }

  public String getCompleteDate(AnterosCupsClient client) throws Exception {
    return this.dateFormat.format(client.getJobAttributes(getJobID()).getJobCompleteTime());
  }

  public String toString(AnterosCupsClient client) {
    try {
